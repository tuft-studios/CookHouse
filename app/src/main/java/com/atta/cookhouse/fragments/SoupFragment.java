...
public class SoupFragment extends Fragment  implements FragmentsContract.View {
    ...
    public void getMenu(){
        ...
        fragmentsPresenter.getMenu(recyclerView, "soup", location);
    }
    ...
    public void showOrderDialog(Dish dish) {
        ...
        ((MainActivity)getActivity()).showOrderDialog(dish, fragmentsPresenter, recyclerView, "soup", location);
    }
